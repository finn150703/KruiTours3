          ...
          <div className="relative max-w-lg w-full mx-5 p-8 bg-white rounded-lg shadow-lg font-sans">
            ...
            <form onSubmit={handleSubmit} className="border border-black p-6 rounded-lg bg-background">
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <div className="flex-1">
                  <label className="block mb-2 text-text font-medium">Type of Activity:</label>
                  <select
                    name="days"
                    value={formData.Tour}
                    onChange={handleChange}
                  ...
                  >
                    ...
                    <option value="1">Surf Lesson</option>
                    <option value="2">River Tubing</option>
                    <option value="3">Rafting</option>
                    <option value="3">Mystical Cave</option>
                    <option value="4">River Swimming</option>
                  </select>
                </div>
              </div>

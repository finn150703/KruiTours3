        ...
        <div className="min-h-screen flex items-center justify-center bg-background relative my-8">
          <div className="relative max-w-lg w-full mx-5 p-8 bg-white rounded-lg shadow-lg font-sans">
            <header className="text-center mb-6 p-5 bg-primary text-white rounded-lg shadow">
              <h1 className="mb-1 text-3xl font-semibold">Krui Tours</h1>
            ...
            <form onSubmit={handleSubmit} className="border border-black p-6 rounded-lg bg-background">
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <div className="flex-1">
                  <label className="block mb-2 text-text font-medium">Type of tour:</label>
                  <select
                    name="days"
                    value={formData.Tour}
                    onChange={handleChange}
                  ...
                  >
                    ...
                    <option value="1">Jungle Trek</option>
                    <option value="2">Banana Island Trip</option>
                    <option value="3">Vulcano Hike</option>
                    <option value="3">Surf Spots</option>
                    <option value="3">Ranau Lake</option>
                  </select>
                </div>
              </div>
